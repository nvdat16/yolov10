...
class CrossAxisAttention(nn.Module):
    ...
    """
    def __init__(self, dim, num_heads=8, sw=8, qkv_bias=True, attn_drop=0.0, proj_drop=0.0):
        super().__init__()
...
class CSWinTransformer(nn.Module):
    ...
    """
    def __init__(self,
                 embed_dim=64, depths=(1, 2, 21, 1), heads=(2, 4, 8, 16),
                 mlp_ratio=4.0, sw=(1, 2, 8, 8), out_channels=(128, 256, 512)):
        super().__init__()
